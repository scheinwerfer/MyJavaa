...
class Messages extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        if (event.getSource() == btn1) {
            JOptionPane.showMessageDialog(this, "Информация...", "Диологовое сообщение", JOptionPane.INFORMATION_MESSAGE);
        }

        if (event.getSource() == btn2) {
            JOptionPane.showMessageDialog(this, "Предупреждение...", "Диалогое сообщение", JOptionPane.WARNING_MESSAGE);
        }
